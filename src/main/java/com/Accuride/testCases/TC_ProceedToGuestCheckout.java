...
public class TC_ProceedToGuestCheckout extends BaseClass {
...
*/	
	...
	public void ProceedToQuote_TC_ID_3_verify_All_product_submenu() throws Exception{
		...
		captureScreen(driver,"verify_All_product_submenu");
		 ...
		 WebElement allSubMenuProduct = driver.findElement(cart.productsubMenu);
		 WebElement productmenubtn = driver.findElement(cart.productMenu);
			Thread.sleep(1000);

		 productmenubtn.click();
		  System.out.println(allSubMenuProduct.getText());
		   Assert.assertEquals(true, allSubMenuProduct.isDisplayed());
...
/*	@Test (priority=4)
	public void ProceedToQuote_TC_ID_5_verify_the_sub_menu_for_MARKETS() throws Exception{
		...
		captureScreen(driver,"verify_the_sub_menu_for_MARKETS");
		 ...
		 WebElement allSubMenuMarket = driver.findElement(cart.marketsubmenu);
		   WebElement marketMenubtn = driver.findElement(cart.marketMenu);
			Thread.sleep(1000);
		   ...
		   //marketMenubtn.click();
		   Assert.assertEquals(true, allSubMenuMarket.isDisplayed());
	...
	@Test (priority=5)
	public void ProceedToQuote_TC_ID_6_verif_sub_menu_for_RESOURCES() throws Exception{
		
logger.info("verif_sub_menu_for_RESOURCES");
		
		captureScreen(driver,"verif_sub_menu_for_RESOURCES");
		
		 WebElement allSubMenuResource = driver.findElement(cart.resourcesubmenu);
		   WebElement resouceMenubtn = driver.findElement(cart.recourceMenu);
			Thread.sleep(1000);

			resouceMenubtn.click();
		   Assert.assertEquals(true, allSubMenuResource.isDisplayed());
...
logger.info("verif_sub_menu_for_SUPPORTS");
		...
		captureScreen(driver,"verif_sub_menu_for_SUPPORTS");
		 WebElement allSubMenusupport = driver.findElement(cart.supportsubmenu);
		   WebElement supportMenubtn = driver.findElement(cart.supportMenu);
			Thread.sleep(1000);

			supportMenubtn.click();
		   Assert.assertEquals(true, allSubMenusupport.isDisplayed());
	...
	@Test (priority=8)
	public void ProceedToQuote_TC_ID_9_verify_menu_for_Store() throws Exception{
		
logger.info("verify_sub_menu_for_Store");
		
		captureScreen(driver,"verify_sub_menu_for_Store");
		
		 WebElement allSubMenucompany = driver.findElement(cart.storeMenu);
		 allSubMenucompany.click();
			Thread.sleep(1000);
...
driver.findElement(cart.LogInbtnnew).click();
		...
		//driver.findElement(cart.loginsignUpbtn).click();
		 WebElement productmenubtn = driver.findElement(cart.productMenu);
			...
			//js.executeScript("arguments[0].click();", productmenubtn);
		    productmenubtn.click();
...
logger.info("validate_switch_button_vertical_horizontal");
		...
		captureScreen(driver,"validate_switch_button_vertical_horizontal");
		 ...
		 WebElement horizontalSwitchFilterbtn = driver.findElement(cart.horizontalSwitchFilter);

		 horizontalSwitchFilterbtn.click();
		 Thread.sleep(1000);
...
js.executeScript("arguments[0].click();", element);
	...
	@Test (priority=30)
	public void ProceedToQuote_TC_ID_44_Verifying_and_clicking_on_ProceedToGuest_checkout() throws Exception{
		
logger.info("Verifying_and_clicking_on_ProceedToGuest_checkout");

          WebElement element = driver.findElement(cart.guestCheckout); 


		   Assert.assertEquals(true, element.isDisplayed());

		
		captureScreen(driver,"Verifying_and_clicking_on_ProceedToGuest_checkout");
...
logger.info("Verifying_and_clicking_on_ProceedToGuest_checkout test is passed");
		
		captureScreen(driver,"Verifying_and_clicking_on_ProceedToGuest");
	...
	@Test (priority=31)
	public void ProceedToQuote_TC_ID_45_46_verify_by_adding_and_updating_new_address() throws Exception{
		
		
logger.info("verify_by_adding_and_updating_new_address");
		
		captureScreen(driver,"verify_by_adding_and_updating_new_address");
		WebElement emalAddressbtn = driver.findElement(cart.emailAddress); 
		//WebElement firstNm = driver.findElement(cart.firstName);
		//WebElement LastNm = driver.findElement(cart.lastName);

		/*WebElement compny = driver.findElement(cart.company);

		WebElement strtAddress = driver.findElement(cart.streetAddress);

		WebElement cityAll = driver.findElement(cart.city);

		WebElement countryGB = driver.findElement(cart.country);

		WebElement stateEU = driver.findElement(cart.state);
		WebElement zipGB = driver.findElement(cart.zip);

		WebElement phnNumbr = driver.findElement(cart.phoneNumber);

		WebElement saveShippingAddres = driver.findElement(cart.saveBtn);
...
*/
		 ...
		 Thread.sleep(1000);
		   ...
		   Assert.assertEquals(true, emalAddressbtn.isDisplayed());
		   emalAddressbtn.sendKeys("Test@test.com");
		   
	/*	   Assert.assertEquals(true, firstNm.isDisplayed());
		   firstNm.sendKeys("Vishal");
		   
		   Assert.assertEquals(true, LastNm.isDisplayed());
		   LastNm.sendKeys("Singh");
		   
		   Assert.assertEquals(true, compny.isDisplayed());
		   compny.sendKeys("Indus");
		   
		   Assert.assertEquals(true, strtAddress.isDisplayed());
		   strtAddress.sendKeys("55 Liliput Road Brackmills Industrial Estate");
		   
		   Assert.assertEquals(true, cityAll.isDisplayed());
		   cityAll.sendKeys("Northampton");
		   
		   Assert.assertEquals(true, countryGB.isDisplayed());
		   
		   Select dropdown = new Select(countryGB);
			 
			 dropdown.selectByValue("GB");
		
		   
		   Assert.assertEquals(true, stateEU.isDisplayed());
		   stateEU.sendKeys("Northampton");
		   
		   Assert.assertEquals(true, zipGB.isDisplayed());
		   zipGB.sendKeys("NN11AL");
		   
		   Assert.assertEquals(true, phnNumbr.isDisplayed());
		   phnNumbr.sendKeys("8961440052");
		   
		   Assert.assertEquals(true, saveShippingAddres.isDisplayed());
		   saveShippingAddres.click();
		*/   
	...
	@Test (priority=32)
	public void ProceedToQuote_TC_ID_45_46_verify_by_adding_and_firstName() throws Exception{
...
logger.info("verify_by_adding_and_updating_new_address");
	...
	@Test (priority=33)
	public void ProceedToQuote_TC_ID_45_46_verify_by_adding_and_LastName() throws Exception{
...
logger.info("verify_by_adding_and_updating_new_address");
	...
	@Test (priority=34)
	public void ProceedToQuote_TC_ID_45_46_verify_by_adding_and_company() throws Exception{
...
logger.info("verify_by_adding_and_updating_new_address");
	...
	@Test (priority=35)
	public void ProceedToQuote_TC_ID_45_46_verify_by_adding_address() throws Exception{
...
logger.info("verify_by_adding_and_updating_new_address");
	...
	@Test (priority=36)
	public void ProceedToQuote_TC_ID_45_46_verify_by_adding_cityall() throws Exception{
		 Thread.sleep(1000);
...
logger.info("verify_by_adding_and_updating_new_address");
	...
	@Test (priority=37)
	public void ProceedToQuote_TC_ID_45_46_verify_by_adding_GB() throws Exception{
		 Thread.sleep(1000);
...
/*	
	@Test (priority=38)
	public void ProceedToQuote_TC_ID_45_46_verify_by_addinSTATE() throws Exception{
...
logger.info("verify_by_adding_and_updating_new_address");
	...
	*/
	@Test (priority=39)
	public void ProceedToQuote_TC_ID_45_46_verify_by_addingZIP() throws Exception{
...
logger.info("verify_by_adding_and_updating_new_address");
	...
	@Test (priority=40)
	public void ProceedToQuote_TC_ID_45_46_verify_by_addinphnumber() throws Exception{
...
logger.info("verify_by_adding_and_updating_new_address");
	...
	@Test (priority=41)
	public void ProceedToQuote_TC_ID_45_46_verify_by_addsavebtn() throws Exception{
...
logger.info("verify_by_adding_and_updating_new_address");
	...
	@Test (priority=42)
	public void ProceedToQuote_TC_ID_47_verify_by_selecting_ShipHere_radio_button() throws Exception{
...
WebElement radioButton = driver.findElement(cart.radioBtn2); 
	...
	@Test (priority=43)
	public void ProceedToQuote_TC_ID_48_validate_by_clicking_next_button() throws Exception{
...
logger.info("validate_by_clicking_next_button");
	...
	@Test (priority=44)
	public void ProceedToQuote_TC_ID_49_verify_UI_of_Payment_page() throws Exception{
...
logger.info("verify_UI_of_Payment_page");
	...
	@Test (priority=45)
	public void ProceedToQuote_TC_ID_50_Add_card_detail() throws Exception{
...
//iframe_by_name.sendKeys("333");
	...
	@Test (priority=46)
	public void ProceedToQuote_TC_ID_51_select_Term_and_condition() throws Exception{
...
WebElement termAndConditionbtn = driver.findElement(cart.termAndCondition); 
	...
	/*
	@Test (priority=47)
	public void ProceedToQuote_TC_ID_58_verify_by_placing_order() throws Exception{
...
logger.info("verify_by_placing_order");
	...
	/*
	@Test (priority=2)
	public void ProceedToQuote_TC_ID_59_verify_order_summery_page() throws Exception{
	}
	
	@Test (priority=2)
	public void ProceedToQuote_TC_ID_45_verify_by_adding_and_updating_new_address() throws Exception{
	}
