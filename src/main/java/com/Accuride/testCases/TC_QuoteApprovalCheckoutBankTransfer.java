...
public class TC_QuoteApprovalCheckoutBankTransfer extends BaseClass{
...
js.executeScript("arguments[0].click();", element);
	...
	@Test (priority=6)
	public void ProceedToQuote_TC_ID_5_BankTransfer() throws Exception{
		
logger.info("bank_transfer_detail");
		
		captureScreen(driver,"Add_card_detail");
		
WebElement banktranferbtn = driver.findElement(cart.banktransfer); 

banktranferbtn.click();
...
logger.info("verify_by_placing_order");
		...
		WebElement placeOrderbutton = driver.findElement(cart.placeOrderbtn2); 
