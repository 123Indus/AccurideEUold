...
public class TC_EULauchCheckoutByLogin extends BaseClass  {
	...
	public void EU_TC_ID_3_verifyUI_Home_page() throws Exception{
		...
		if(driver.getTitle().equals(k))
		{
			...
			logger.info("VerifyUI test passed");
			captureScreen(driver,"required_mandatory_field");
		}
		else
		{
			captureScreen(driver,"titleverify");
			Assert.assertTrue(false);
			logger.info("Title test failed");
			captureScreen(driver,"_mandatory_field");
		}
		Thread.sleep(2000);
...
logger.info("validate_switch_button_vertical_horizontal");
	...
	@Test (priority=31)
	public void EU_TC_ID_45_46_verify_by_adding_and_updating_new_address() throws Exception{
	...
	@Test (priority=34)
	public void EU_TC_ID_49_verify_UI_of_Payment_page() throws Exception{
	...
	public void EU_TC_ID_51_select_Term_and_condition() throws Exception{
		...
		WebElement termAndConditionbtn = driver.findElement(cart.termAndCondition2); 
...
logger.info("verify_by_placing_order");
		...
		WebElement placeOrderbutton = driver.findElement(cart.placeOrderbtnSEPA); 
